...
const DashboardSession = () => {
  return (
    <div className="md:w-[85vw] w-full h-screen bg-[#EEEEEE] overflow-auto  cursor-pointer">
      <div className="md:py-[1vw] md:px-[2vw] p-[6vw] w-full flex justify-between items-center">
        ...
        <Hamburger />
        <span className="md:px-[2vw] md:py-[1vw] py-[3vw] px-[5vw] bg-white rounded-full flex  gap-3 shadow-sm font-bold text-sm items-center cursor-pointer">
          Add New Analyst
          <CiSaveDown1 />
        </span>
      </div>
